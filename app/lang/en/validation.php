...
return array(
	...
	*/
	...
	'custom' => array(
		...
		'date' => array(
			'required' => 'Du skal vælge en dato og et tidspunkt for aktiviteten.',
			'min' => 'Du skal minimum indtaste :min karakterer.',
		),
		'firstName' => array(
		...
		'zip' => array(
		'required' => 'Du skal indtaste et postnummer',
			'numeric' => 'Du skal indtaste et gyldigt postnummer',
			'min' => 'Postnummeret skal minimum være :min',
			'max' => 'Postnummeret må maximum være :max',
		),
		'city' => array(
			'required' => 'Du skal indtaste din by.',
			'min' => 'Du skal minimum indtaste :min karakterer.',
		),
		'participants' => array(
